...
class GarmentRenderer:
    ...
    def load_obj(self, path, material):
        ...
        if not bpy.context.selected_objects:
            print("No objects selected after import. The .obj file might be empty.")
            raise ValueError("No objects selected after import. The .obj file might be empty.")
